...
function OperatorDashboard() {
  ...
  const stats = [
    ...
    { icon: "⏳", title: "Pending", value: pendingCount.toString(), color: "bg-amber-50 text-amber-700" },
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Operator Profile Not Found</h1>
          <p className="text-gray-600">Your operator account is not linked. Please contact admin.</p>
        </div>
      </div>
    );
  }
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <h3 className="text-lg font-bold text-gray-800">My Tour Packages</h3>
        ...
        {myTours.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No tour packages assigned yet.</p>
        ...
        <h3 className="text-lg font-bold text-gray-800 mb-4">Booking Requests</h3>
        {filteredBookings.length === 0 ? (
          <p className="text-center text-gray-500 py-8">No bookings found for your packages.</p>
        ) : (
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="pb-3 text-sm font-semibold text-gray-500">Tour Package</th>
