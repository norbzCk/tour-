      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <Link
              to="/tours"
              className="px-6 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-2xl font-bold hover:shadow-lg hover:shadow-green-200 transition flex items-center gap-2"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 rounded-2xl border border-gray-200 focus:outline-none focus:ring-4 focus:ring-green-100 focus:border-green-500 transition bg-white shadow-sm"
                value={search}
                ...
                {filtered.map((booking, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6 flex flex-col md:flex-row gap-6 group hover:shadow-xl transition-all"
                    >
                      {tour && (
                      ...
                      <div className="flex-1 space-y-3">
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                          <h3 className="text-xl font-bold text-gray-900 group-hover:text-green-700 transition-colors">{booking.tourTitle}</h3>
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm">
                          ...
                          <span className="font-bold text-green-700 bg-green-50 px-3 py-1.5 rounded-full">
                        ...
                        <div className="flex flex-wrap gap-4 text-sm text-gray-500 pt-2">
                          ...
                          {booking.transactionId && (
                            <span className="flex items-center gap-1 bg-gray-50 px-2.5 py-1 rounded-full font-mono">
                              🧾 {booking.transactionId}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                          ...
                          {booking.status === "Pending" && (
                            <button
                              ...
                              className="px-4 py-1.5 text-xs font-semibold text-red-600 bg-red-50 rounded-full hover:bg-red-100 transition"
                            >
                              Cancel Booking
                            </button>
                          )}
